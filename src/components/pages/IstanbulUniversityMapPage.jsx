...
// The publishable (pk.) Mapbox token for accaco.com, stored base64-encoded.
// It is NOT a secret — a publishable token is sent to the browser on every map
// request by design — but GitHub secret-scanning flags any pk./sk. token in
// source, so it is encoded here to keep it out of plaintext. A host env var
// (VITE_MAPBOX_ACCESS_TOKEN on Vercel) overrides it. Restrict this token by URL
// (accaco.com / *.accaco.com) in the Mapbox account to prevent off-site use.
function decodePublishableMapboxToken() {
...
const GEO_POINTS = [
  ...
  ['Istinye University', 41.10223, 28.97511, 'Vadi Istanbul', 'europe'],
  ...
  ['Bahcesehir University', 41.04167, 29.00677, 'Besiktas', 'europe'],
...
const SECONDARY_CAMPUSES = [
  ...
  ['ISTANBUL NISANTASI UNIVERSITY', 41.11567, 29.01389, 'NeoTech Campus (Maslak)', 'europe'],
  ['ISTINYE UNIVERSITY', 41.10448, 28.98602, 'Vadi Campus (Ayazağa)', 'europe'],
  ...
  ['ISTANBUL KULTUR UNIVERSITY', 40.99457, 28.87143, 'İncirli Campus', 'europe'],
  ...
  ['ISTANBUL AREL UNIVERSITY', 41.0124, 28.91475, 'Cevizlibağ Campus', 'europe'],
  ['ISTANBUL AREL UNIVERSITY', 40.99992, 28.79637, 'Sefaköy Campus', 'europe'],
  ...
  ['BAHCESEHIR UNIVERSITY', 41.04998, 29.00732, 'Beşiktaş South Campus', 'europe'],
...
const MAP_LANDMARKS = [
  ...
  ['hospital', 'Liv Hospital Ulus', 29.02730, 41.06650],
  ['hospital', 'Liv Hospital Vadistanbul', 28.99850, 41.10850],
  ['hospital', 'Liv Hospital Samandıra', 29.21000, 40.98850],
];
...
const MAP_PLACES = [
  ...
  ['immigration', 'Migration Office — Esenyurt', 28.64498, 41.03818],
  ...
  ['dorm', 'Student Housing — Esenyurt', 28.68486, 41.01880],
  // Named dorms (Google-Maps verified)
  ['dorm', 'Mehterçeşme Erkek Öğrenci Yurdu (Esenyurt)', 28.66928, 41.01386],
  ['dorm', 'Evimyurdum Kız Öğrenci Yurdu (Esenyurt)', 28.68619, 41.02397],
  ['dorm', 'GSB 1453 Öğrenci Yurdu (Esenyurt)', 28.68704, 41.00375],
  ['dorm', 'Gözde Öğrenci Yurdu (Avcılar)', 28.72063, 40.99047],
  ['dorm', 'Hayat Yurtları (Avcılar)', 28.71634, 40.98984],
  ['dorm', 'İstasyon Kız Öğrenci Yurdu (Merter)', 28.89863, 41.00971],
  ['dorm', 'Osmaniye Erkek Öğrenci Yurdu (Bakırköy)', 28.87733, 40.99370],
  ['dorm', 'Merter Kız Öğrenci Yurdu', 28.88362, 41.00461],
  ['dorm', 'Atatürk Öğrenci Yurdu (Cevizlibağ)', 28.91356, 41.01364],
  // 10 more student dorms across Istanbul (approx KYK/district locations, draggable)
  ['dorm', 'KYK Vefa Yüksek Öğrenim Yurdu (Fatih)', 28.9570, 41.0185],
  ['dorm', 'KYK Florya Kız Öğrenci Yurdu (Bakırköy)', 28.7875, 40.9765],
  ['dorm', 'KYK Bahçelievler Öğrenci Yurdu', 28.8590, 41.0010],
  ['dorm', 'KYK Başakşehir Öğrenci Yurdu', 28.8060, 41.0920],
  ['dorm', 'KYK Gaziosmanpaşa Öğrenci Yurdu', 28.9120, 41.0680],
  ['dorm', 'KYK Üsküdar Validebağ Yurdu', 29.0455, 41.0215],
  ['dorm', 'KYK Kadıköy Öğrenci Yurdu', 29.0620, 40.9850],
  ['dorm', 'KYK Ümraniye Öğrenci Yurdu', 29.1230, 41.0220],
  ['dorm', 'KYK Pendik Öğrenci Yurdu', 29.2300, 40.8850],
  ['dorm', 'KYK Tuzla Öğrenci Yurdu', 29.3000, 40.8200],
  ...
  ['library', 'Esenyurt Public Library', 28.68294, 41.02830],
